...
| 112  | [Addle Brain](#addle-brain)                                 | Target must pass PRS save or drop to 0 PRS for 1 hour.       |
...
| 124  | [Arcane Stain](#arcane-stain)                               | Inscribes an invisible rune you can feel. Suffer 1d4 PRS loss if removed. |
...
| 132  | [Banishment](#banishment)                                   | PRS save or creature to returns to native plane.             |
...
| 134  | [Beguilement](#beguilement)                                 | Target humanoid must make a PRS save or is controlled telepathically. |
...
| 151  | [Burnishing Bubble](#burnishing-bubble)                     | Target is enclosed by an impenetrable sphere that rolls along the ground, unless they pass a AGL save. |
...
| 212  | [Create Unlife](#create-unlife)                             | Creates 1d4 undead skeletons and zombies from corpses. PRS save every hour to control them. |
| 213  | [Curse of the Sightless](#curse-of-the-sightless)           | Anyone within eyesight must make a PRS save or be blinded.   |
...
| 223  | [Devil's Comedian](#devils-comedian)                        | PRS save or target laughs uncontrollably, unable to take any action. |
| 224  | [Disaster Fluid](#disaster-fluid)                           | Anything in a 10ft square becomes slippery; AGL save to avoid slipping. |
...
| 242  | [Ensorcelled](#ensorcelled)                                 | Creatures are enraptured for a few minutes unless they pass a PRS save. |
| 243  | [Envision](#envision)                                       | Spies on a target you have met, even across vast distances. On a PRS save, they can feel your presence. |
...
| 252  | [Feline Agility](#feline-agility)                       | Target becomes limber, lithe and as fast as quicksilver.     |
...
| 265  | [Foolishness](#foolishness)                                 | A target you touch becomes vulnerable to wild mood swings, sweeping conclusions and silly behavior. They also lose 1d6 PRS for 24 hours (down to a minimum of 1). |
...
| 316  | [Gorgon's Gaze](#gorgons-gaze)                              | Target is transformed into a statue on a failed PRS save. A success reverses the spell; holder must pass a PRS save or the book is destroyed. |
...
| 332  | [Hoodwink Monster](#hoodwink-monster)                       | Target monster makes a PRS save or treats you as an ally.    |
...
| 344  | [Induce Despair](#induce-despair)                           | Target must pass a PRS save or its attacks are impaired.     |
| 345  | [Induce Horror](#induce-horror)                             | Target makes a PRS save or flees.                            |
...
| 361  | [Lichsense](#lichsense)                                     | You feel any undead within 60ft. PRS save to avoid detection by intelligent undead. |
...
| 412  | [Manic Fury](#manic-fury)                                   | A target's attacks are enhanced. They must make a PRS save after a successful killing or lose control, attacking anyone in sight. |
| 413  | [Masquerade](#masquerade)                                   | You assume the likeness of a similar creature you have seen. |
| 414  | [Master Undead](#master-undead)                             | Undead creatures obey your command. Intelligent undead make a PRS save. |
...
| 432  | [Necrotic Touch](#necrotic-touch)                           | Target must AGL save or is paralyzed.                        |
...
| 453  | [Perfect Illusion](#perfect-illusion)                       | Creates an image with sound, smell and thermal effects, activated according to a trigger you choose. Touching the image or making a successful PRS save will reveal the illusion. |
...
| 456  | [Phase Anchor](#phase-anchor)                               | Binds an extraplanar creature to your will until it performs a task specific task, after which they must pass a PRS save to escape (good luck). |
...
| 513  | [Prisma Shard](#prisma-shard)                               | An array of hypnotic lights fascinate nearby creatures, unless they pass a PRS save. |
...
| 523  | [Pyramid of Passivity](#pyramid-of-passivity)               | Target creatures must make a AGL save or their attacks are impaired. |
...
| 534  | [Runic Harm](#runic-harm)                                   | A rune you draw causes great pain to the reader, who must PRS save or scream until they pass out (1d4 PRS loss). A successful save destroys the rune. |
...
| 541  | [Scintillate](#scintillate)                                 | Target must PRS save or their attacks become impaired.       |
...
| 556  | [Sinister Polymorph](#sinister-polymorph)                   | PRS save or target is transformed into a harmless animal.    |
...
| 611  | [Soul Annex](#soul-annex)                                   | Target's spirit is caged within their body and replaced with the caster's. If the body is slain the original soul departs, but the caster must pass a PRS save to return to their body. |
...
| 615  | [Stupefaction](#stupefaction)                               | Target temporarily loses sense of place and time. PRS save to overcome. |
...
| 624  | [Terrify](#terrify)                                         | Targets within eyesight must pass a PRS save or flee.        |
| 625  | [Terrifying Illusion](#terrifying-illusion)                 | A target is hunted by a terrible creature only they can see. Its attacks do 1d12 damage; on Critical Damage they must pass a PRS save or become catatonic. |
...
| 632  | [Tongue of the Blue Serpent](#tongue-of-the-blue-serpent)   | Rust-colored, serpentine letters materialize on a surface you choose. Anyone reading these words becomes immobilized unless they succeed a PRS save. |
...
| 641  | [Trueshift](#trueshift)                                     | A willing target takes on a new form (keeping only their PRS), but must pass a PRS save to shift out. |
...
| 646  | [Undeniable Courage](#undeniable-courage)                   | Target passes next PRS save and their attacks are enhanced.  |
