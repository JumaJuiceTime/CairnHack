...
| **5** | Wolves, or so you thought. You are now a **Werewolf** [8 HP, 15 STR, 14 AGL, claws (d6+d6), bite (d8)]. Your PRS remains the same. You can _turn_ at will (once per day) but must make a PRS save to revert. Anyone left alive from your attacks must make a PRS save to avoid infection. |
