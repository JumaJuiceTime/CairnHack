...
### Blind Antler Man
10 HP, 3 Armor, PRS 18, death ray pistol (d12), self-heating sword (d10), exploding bolos (d6, blast)

### Captain Kyrn
10 HP, 2 Armor, STR 12, AGL 12, PRS 12, bug zapper (d6), sword (d8)
...
8 HP, 3 Armor, 8 STR, 14 PRS, anti-chaos sword (d8, d12 vs creatures of chaos)

### Cyclops
13 HP, 18 STR, 8 AGL, 6 PRS, club (d10)

### Decapitante
4 HP, 1 Armor, 3 PRS, glaive (d8)

### Dim
6 HP, 1 Armor, 16 STR, 6 PRS, fist (d6), scimitar (d8)

### Doomed Templar
4 HP, 3 Armor, 8 PRS, sword (d8)

### Dr. Ephraim Thontorius
5 HP, 1 Armor, STR 13, gamma gun (d10), bear hands (d6)

### Dwarf, Bat-Winged
4 HP, 1 Armor, 13 STR, 8 PRS, axe (d8), bow (d6)

### Dwarf, Blue
4 HP, PRS 12, hammer or wrench (d6)
...
### Firebomb Beetle
2 HP, 2 Armor, STR 8, AGL 8, WILL 8, firebomb (d6, blast)
...
10 HP, 3 Armor, STR 13, AGL 13, spear (d8)

### Gatemaster Shamblebeard
10 HP, 3 Armor, 13 STR, 13 PRS, axe (d8)

### Mr. Ghacula
8 HP, 2 Armor, scimitar (d8)

### Giant Cave Swallow
4 HP, STR 8, AGL 12, PRS 6, beak (d6)
- Critical damage: Any rope on your person is stolen.

### Giant Pill Bug
3 HP, 1 Armor, PRS 6, bite (d4)
...
### Guard Bot
4 HP, 1 Armor, AGL 8, pincers (d6)  
- Foam cannon: blast, AGL save or be immobilized
- Stun beam: PRS save or fall unconscious for 2d4 rounds
...
4 HP, 2 Armor, STR 12, PRS 12, scimitar (d8), bow (d6)
- Critical Damage (bow): Target is paralyzed for d6 minutes.

### Hrrk, Magman Prince
18 HP, STR 16, AGL 14, PRS 16, fiery fists (d12+d12)
- Anyone within 10 ft must pass a STR save or suffer d6 heat damage.

### Ilgoriath
11 HP, 1 Armor, STR 8, AGL 8, PRS 16, parrying dagger (d6)
...
HP 12, STR 15, AGL 13, WILL 13, sword of calamity (d10), daggers (d6)

### Kholopho
4 HP, 2 Armor, STR 12, PRS 8, stone polearm (d10), obsidian axe (d8)

### Kilifrix the Devil-Mantis
10 HP, 3 Armor, STR 12, AGL 12, claws (d6+d6)

### Krrgh, Magman Prince
18 HP, STR 16, AGL 16, PRS 14, fiery fists (d12+d12)
- Anyone within 10 ft must pass a STR save or suffer d6 heat damage.
...
- Mind blast requires target to pass PRS save or be stunned for d4-1 rounds
...
10 HP, STR 16, AGL 14, PRS 14, ape-bronze sword (d12)
...
- Stun ray (AGL save or be rendered unconscious)
...
- Spellcasters must make a PRS save or magic against the giant fails

### Shaggankh, Son of Shaggath-Ka
22 HP, 3 Armor, 18 STR, 14 AGL, 14 PRS, tentacles (d10+d10)
- corrosive breath (2d8, blast, AGL save for half damage)

### Shaggath-Ka, the Worm Sultan
36 HP, 3 Armor, 12 STR (down from 18), 14 AGL, 18 PRS, smash (2d8, blast), _detachment_
- Lethal gaze (PRS save or die)
- Can cast *wizardsniff, hoodwink person, murky bubble, read thoughts, fog of nausea, vines of ichor, lightning strike*

### Shoo-loo-ah, Slugman
4 HP, 8 STR, 6 AGL, 12 PRS, curved dagger (d6)

### Solaro, White Humanoid Fighter
8 HP, 3 Armor, STR 12, PRS 8, scimitar (d8)
...
32 HP, 3 Armor, 18 STR, 18 AGL, 18 PRS, countless biting snakes ((2d6)d6)
...
### Underworld Ranger
8 HP, 2 Armor, 12 STR, 12 AGL, 12 PRS, sword (d8), bugzapper (d6)

### Urethria, Priestess of Nul
10 HP, 2 Armor, PRS 14, stiletto (d6)
...
### Uurx the Impervious
28 HP, 3 Armor, 18 STR, 14 AGL, 14 PRS, accidental misstep (d12)

### White Humanoid
4 HP, 1 Armor, spear (d8)

### Worm Father Ymoro
12 HP, 18 PRS, dagger (d6)
...
### Worm Soldier
5 HP, 2 Armor, 15 PRS, spear (d8) or shortbow (d6)
...
When first donning the helmet, user must make a PRS save to avoid immediate death. Provided they survive, after a coma lasting d12 hours, the user can cast *hoodwink person, invisibility, mind reader, psychic touch*.
...
### Fungi of Healing
Restores d4 STR, lose 1 PRS. Takes a turn of vigorous chewing to take effect.

### Healing Salve
Restores d4 STR, lose 1 PRS.

### Monster Repellent
Incense burns for 24 hours. Unintelligent creatures must PRS save or be driven off by the unpleasant smell.
...
### Nul Rod
Functions as 2d6 weapon against creatures of Chaos. Permanently dispels and nullifies all magic within 20 ft. Spellcasters within sight of the Nul Rod must PRS save each time they cast a spell or it fails.
...
Grants 18 STR and reduces PRS to 3 for 1 hour. User is incapable of language or rational decision-making during that time.

### Potion of Spectral Foetor
Terrible smell emits from drinker, requiring carnivorous animals to pass a PRS save or flee.
...
### Stone Cloak
In rocky surroundings, the user may always avoid ordinary visual detection with a successful AGL save.
...
Most mortals who meet the user's gaze must make a PRS save or die.
...
### Diet of the Worm
Target makes a STR save or continuously vomits a vast sum of soil & stone for d6 rounds. After vomiting, they make a PRS save or be incapacitated by pained sobbing for an additional d6 rounds.
...
Target must save vs AGL to avoid being trapped in a globe of mucus surrounded by a thick leathery membrane. Anyone can free the target with an edged weapon or a successful STR save; either way escape or rescue takes 2d6 rounds.
...
1 HP, 2 Armor, STR 12, AGL 14, PRS 9
...
### Sergeant Gamnon
4 HP, 3 Armor, STR 12, AGL 8, PRS 10
-  longsword (d8)
-  lamp's hue
 bow (d6, bulky)
...
### Ghanulor of Ixmer
2 HP, 3 Armor, STR 12, AGL 10, PRS 11
...
### Gooth of House Ygar
3 HP, 2 Armor, STR 10, AGL 12, PRS 11
-  polearm (d10, bulky)
-  short sword (d6)
-  hovering protection
 (1 armor)
...
6 HP, 1 Armor, STR 16, AGL 10, PRS 12
...
5 HP, 3 Armor, STR 12, AGL 9, PRS 9
...
### Shantora Lax
5 HP, STR 8, AGL 11, PRS 10
-  platemail (3 armor)
-  greatsword (d10)
-  2 flasks of oil

### "Smash" Hannigan
STR 13, AGL 12, PRS 11
