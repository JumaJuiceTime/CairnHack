...
At night, +1 to start-of-combat AGL saves.

### All other wares as described.

## Demonic Possession and You!
### Possessed Villager
3 HP, 15 STR, 10 AGL, 18 PRS, unnatural strength (d6)
- On failing a STR save against critical damage, 50% chance to avoid critical damage.

### The Soggy Bottom Inn
Hagstooth Mead - If consumed, the drinker has advantage on PRS saves for an hour, after which they have disadvantage on PRS saves for two hours.
...
### Fungal Bug
5 HP, 2 Armor, 10 STR, 12 AGL, 1 PRS, slicing pincers (d8), crushing legs (d6+d6)
- Critical Damage: Fungal Cloud - Lets loose a vicious spray of fungus spores. Make a PRS save or become infected by the Levanian cordyceps, losing 1 PRS per day. When an infected character reaches 1 PRS, they become insane, attacking anything that moves and dealing Fungal Cloud as critical damage. Consuming any hallucinogenic substance kills the cordyceps, ending the effect.

### Spore Field
- A wide patch of fungi stretches out before the party. Disturbing the fungi releases clouds of toxic spores. The first inhalation of these spores reduces characters' HP to zero. Subsequent inhalations deal 1d4 damage to AGL. Going around the fungi increases travel time by one travel turn. Attempting to run through the fungi with no protection will require each character to make a PRS save to hold their breath.

### Snakes of Large Size
3 HP, 1 Armor, 10 STR, 12 AGL, 5 PRS, bite (d4 and poisoned)
- Poisoned characters take 1d4 damage each round for 1d4 rounds

### Three-Headed Giant Snake
5 HP, 2 Armor, 15 STR, 11 AGL, 5 PRS, bite (d8+d8+d8)
...
- The Demon Box: Requires a PRS save to bind the demon.
...
### 8. Shade
2 HP, 8 STR, 14 AGL, 8 PRS, corrupting claws (d4)
...
## Corruption
### The THING
6 HP, X STR, 18 AGL, 18 PRS, claws (d6+d6)
- STR = Paranoia x 3 + 3
...
Target has -2 on all rolls. Target can make a PRS save to rid themselves of the corruption, but failing the save causes them to fall into a stupor for 1d4 rounds.
...
- Grix's box takes three turns to use. On the second turn, the user may make a PRS save to complete the ritual a turn early. On a failure, the box lashes out at the user's mind, dealing 1d4 PRS damage, and the ritual must be started from the beginning.
