...
### Random Events
- Gazing at the violet-eyed owl: save PRS to avoid fainting.
- Gust of wind: AGL save to avoid taking 1 STR damage.
...
- The "young woman" (Briar-Anne) is standard NPC but with relatively high PRS (4HP, 10/10/15).

#### Hooded Men (aka Drunes)
12 HP, 9 STR, 12 AGL, 14 PRS, staff wreathed in green flame (d8), Spellbooks (_Charm Person, Magic Missile, Hold Person, Topple Dolmen_)  
- _Charm Person_: Target sees caster as a friend until they succeed a PRS save.
- _Hold Person_: Target is paralyzed until they succeed a PRS save. Undead are _not_ affected.
- _Magic Missile_: A bolt of arcane green energy that causes d6 damage, ignoring mundane armor.
- _Topple Dolmen_: One of the dolmens begins to glow eerily, then levitates from the circle and topples onto a spot within 30', doing 4d6 _Blast_ damage on a failed AGL save (the stones move quite slowly).
...
- Touching the staff for the first time causes 1d4 PRS damage. Survivors have power over the staff, which allows the bearer to hear the thoughts of others.
...
- AGL save to avoid being heard by the worms.
...
- _Hold Person_: Target is paralyzed until they succeed a PRS save. Undead are _not_ affected. See rules for Scrolls in the [SRD](/cairn-srd/#magic).
...
#### Mould-Patched Walls
- Raises a cloud of spores. Everyone within 10' makes a PRS save or suffer 1d4 STR damage and be stricken with violent coughing and choking for 1 turn.

### 12. Hall of Hounds
#### Stone Hounds
16 HP, 3 Armor, 16 STR, 12 AGL, 1 PRS, bite (1d8)
...
- 18 HP, 3 Armor, 14 STR, 16 AGL, 18 PRS, aging touch (1d6)
...
### 16. Entrance Hall
#### Dolmenwood Troll
14 HP, 2 Armor, 18 STR, 9 AGL, 12 PRS, moss fists (d10)
...
#### Dolmenwood Goblin
4 HP, 1 Armor 8 STR, 11 AGL, 8 PRS, spear (d6), Spells (once per day: _Charm person_, _Darkness_, _Sleep_, _Phantasmal Force_)
- _Charm Person_: Target sees caster as a friend until they succeed a PRS save.
- _Darkness_: Creates a shroud of magical darkness in a 15' radius.
- _Sleep_: A creature you can see falls into a light sleep.
- _Phantasmal Force_: You create a convincing illusion in the mind of a living creature, stimulating sound, touch, and temperature as if it were real. A PRS save is required to break the vision.

### 17. Fairy Kitchen
#### Frost Elf Cooks
8 HP, 9 STR, 13 AGL, 12 PRS, knife (d6), rolling pin (d4)

### 18. Wedding Feast
#### Frost Elf Guards and Knights
11 HP, 2 Armor, 8 STR, 13 AGL, 14 PRS, spear or lance (d8)

#### Frost Elf Nobles
11 HP, 1 Armor, 8 STR, 13 AGL, 14 PRS, icicle dagger (d6), a Spellbook (_Sleep_ or _Hold Person_)
- _Sleep_: A creature you can see falls into a light sleep.
- _Hold Person_: Target is paralyzed until they succeed a PRS save. Undead are _not_ affected.

### 19. The Princess's Bedchamber
#### Princess Snowfall-at-Dusk
16 HP, 1 Armor, 8 STR, 15 AGL, 16 PRS, icicle dagger (d6), Spellbooks (_Charm Person_, _Sleep_, _Hold Person_, _Invisibility_)
- _Charm Person_: Target sees caster as a friend until they succeed a PRS save.
- _Sleep_: A creature you can see falls into a light sleep.
- _Hold Person_: Target is paralyzed until they succeed a PRS save. Undead are _not_ affected.
...
- As written; the unwilling should make a PRS save.
