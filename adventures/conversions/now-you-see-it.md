...
- Treat **Discerning Spirits** checks like PRS saves.
- Treat **Tools and Talents**, **Agility**, and **Alertness** checks like AGL saves or roleplay if a character has an appropriate background.
