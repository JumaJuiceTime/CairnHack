...
- Posession: One target must save PRS or be posessed, being controlled by the ghost until it's somehow driven off (this add is from cairn srd)

### Giant Beetle
7 HP, 2 Armor, STR 12, 10 AGL, 10 PRS, bite (d8)
- A hardshell insect used as a beast of burden

### Giant crow
9 HP, 10 STR, 12 AGL, 10 PRS, peck and talons (d8+d6)
...
### Goblin
4 HP, 8 STR, 12 AGL, 8 PRS, dagger (d6) or sling (d4)
...
### Mud Dragon
HP 12 , 14 STR, 11 AGL, 15 PRS Armor 1, detachment, bite (d12) or 2 claws (d8+d8)
...
### Myconids
HP 5, 10 STR, 10 AGL, 12 PRS, spear (d6)
...
### Orangutan
5 HP, 12 STR, 10 AGL, 10 PRS, 2 fist (d8+d8)

### Skeeters
4 HP, STR 10, AGL 10, PRS 10, bite (d6)
- Large bloodsucking insects
- Fly

### Skeleton
5 HP, 10 STR, 13 AGL, 10 PRS, stab (1d6)
- Piercing and slashing weapon attacks against it are _impaired_

### Spiders
5 HP, STR 11, AGL 11, PRS 10, bite (d6)
- Climb walls
- Web: AGL save or get stuck in a web
- Silent: if not spotted they surprise the party

### Stone ogre
8 HP, 2 Armor, 10 STR, 6 AGL, 10 PRS, 2 fist (d6+d6)
...
5 HP, 8 STR, 12 AGL, 8 PRS, bite (1d6) or Rot Blast (d6)
...
### Vastion the Vampire
12 HP, 1 Armor, 14 STR, 12 AGL, 16 PRS, bite (d6) or stab (d8)
...
### Sunclair Dirtfin
6 HP, 12 STR, 10 AGL, 8 PRS, bite and stab (d6+d8)
...
### Ratzin the Fairy
10 HP, STR 10, AGL 10, PRS 10, 1 shock+1 bite (d6+d6)
...
5 HP, STR 10, AGL 10, PRS 10, bite (d6)
