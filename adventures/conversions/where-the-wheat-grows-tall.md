...
- d10+PRS instead of WIS
- Fey reaction: go first against Faerie creatures in combat.

### 15. Stoneface Guardian
- Stoney Gaze: PRS save to avoid petrification

### 16. Likho's House
- Mantelpiece: AGL save or 1d4 STR damage.
- Muffins: heal 1d4 STR.
- Silver mirror: PRS save or they cannot take their next action.
- Cookie Jar: heals 1 STR each, but _deprived_ for the rest of the day.

## Bestiary
### The "House Spirit" (Oleg)
- 4 HP, 5 STR, 11 AGL, 12 PRS

### Old Svarg
5 HP, 1 Armor, 8 STR, 12 AGL, 15 PRS, fire sickle (d6)
- Critical damage: 1d4 items catch fire and are destroyed (flammable or valuable first)

### Barstukai
2 HP, 4 STR, 12 AGL, 5 PRS, claws (d4), farming tools (d6)
- Can vanish into the crops without a save (their laughter may reveal location).

### Crops Spirit
10 HP, 1 Armor, 9 STR, 14 AGL, 6 PRS, farming tools or talons (d8+d8)
- If attacked, animates crops to subdue attacker (AGL to break free). On a fail, the target is strangled unconscious and eventually asphyxiates.

### Crow/Owl Spirit
5 HP, 1 Armor, 8 STR, 10 AGL, 12 PRS, farming tool (d6), flock of birds (d4, _blast_)
...
### Ghosts
4 HP, 2 Armor, 12 STR, 14 AGL, 16 PRS, old weapon (d6)
- Flashback: Target loses 1d4 PRS and must make a PRS save or lose their next action as they relive the spirit's death.
- Attacks against Ghosts are _impaired_.

### The Likho, The One Eyed Witch
8 HP, 1 Armor, 14 STR, 8 AGL, 12 PRS, claws (d4+d4), gaze attack (once each, permitting)
- **Midnight Gaze**: target is paralyzed and blind and must make a PRS save to break free.
- **Sunstrike Gaze**: target takes 1d6 STR damage and then must make a PRS save or believe they are on fire.

### Night Goblins
2 HP, 6 STR, 13 AGL, 5 PRS, claws (d4)

### Night Spirit
8 HP, 1 Armor, 12 STR, 9 AGL, 12 PRS, bite (d8)

### Noon Wraith
8 HP, 1 Armor, 8 STR, 11 AGL, 15 PRS, claws (d6+d6), sunstrike
- **Sunstrike**: target takes 1d4 STR damage and must then make a PRS save or believe they are on fire.

### Poleviks
6 HP, 1 Armor, 12 STR, 10 PRS, claws (d4), farm tools (d6)
- **Grasping Roots**: target is engulfed by strangling roots. On their next turn, make a STR save or be buried under ground.

### Scarecrow Piotr
9 HP, 1 Armor, 12 STR, 8 AGL, 18 PRS, claws (d6+d6)
...
### Sunstroke Thrall
4 HP, 8 STR, 5 AGL, 11 PRS, farming tool (d6)

### Trull The Troll
8 HP, 2 Armor, 14 STR, 11 AGL, 11 PRS, toadslap (d6+d6, _blast_)
- Critical damage: characters are hurled into stream.
- In shadowed water regenerates 2 STR per round.

### Turnip Jack
6 HP, 1 Armor, 11 STR, 9 AGL, 11 PRS, farming tool (d6)
- Regenerates 2 STR when eating light from his lantern.

### Spiteful Wierga
5 HP, 1 Armor, 11 STR, 12 AGL, 8 PRS, claws (d6)
