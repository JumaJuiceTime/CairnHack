...
- Medical treatment: Costs 10gp per STR or AGL point healed.
...
8 HP, 1 Armor, 13 STR, 11 AGL, 15 PRS, bejeweled cutlass (d10)

## Pirates!

### Amra the Tigress

11 HP, 1 Armor, 8 STR, 15 AGL, 13 PRS, sword (d8) or dagger (d6)

### Gentleman James

3 HP, 7 STR, 9 AGL, 8 PRS, gilded sword (d10)

### Mr. Stubbs

7 HP, 1 Armor, 14 STR, 9 AGL, 12 PRS, sword (d8) or crossbow (d6)

### Mancomb Spotswood

8 HP, 1 Armor, 10 STR, 12 AGL, 14 PRS, sword (d8)

### Harkness the Hangman

6 HP, 1 Armor, 11 STR, 11 AGL, 8 PRS (appears as much higher PRS), sword (d8)

### Old Tom

3 HP, 1 Armor, 5 STR, 7 AGL, 8 PRS, weapon (d6)

### Battleaxe Barnaby

6 HP, 1 armor (from necklace), 14 STR, 10 AGL, 13 PRS, handaxes (d6+d6)
- Head of her late husband as a necklace : +1 Armor, but only for her.

### Crews

You can treat the crews as detachments: 6 HP, 10 STR, 10 AGL, 10 PRS, swords (d8). The crew of the Bottom Feeder should be weaker: 3 HP, 7 STR, 7 AGL, 7 PRS, daggers (d6).
...
- Sudden fainting spells: PRS save when scared or excited or pass out.
- Anger issues: PRS save when angered or get violent.
...
3 HP, 10 STR, 10 AGL, 10 PRS, *detachment*

#### First mate

5 HP, 10 STR, 10 AGL, 12 PRS

#### Captain

7 HP, 10 STR, 10 AGL, 14 PRS

### Treasure Ship

#### 40 sailors

two *detachments* with each 3 HP, 10 STR, 10 AGL, 10 PRS
...
8 HP, 7 STR, 12 AGL, 13 PRS, claws (d4+d4)
- Song: Those who hear the song must succeed at a PRS save or move towards the sirens, even jumping into the sea or crashing the ship to reach them. Those under the spell see the sirens as beautiful beckoning figures, their bites and scratches as kisses and caresses.

## Temple of the Monkeys

### Giant Leech

6 HP, 1 Armor, 15 STR, 7 AGL, 5 PRS, bite (d6)
- **Critical Damage**: Recovers all its STR as it drains the target’s blood.

### Cap’n

8 HP, 1 Armor, 16 STR, 12 AGL, 14 PRS, sword (d8)
...
6 HP, 2 Armor, 12 STR, 8 AGL, 10 PRS, blows (d6+d6)
- Not affected by Morale Saves.

### Sealed Reliquary

- Diamond hit by sunlight: Creatures of beast-level intelligence must succeed at a PRS save or be mesmerized.

## Fire Island

### Masked Soldier

5 HP, 10 STR, 10 AGL, 12 PRS, obsidian club (d6)

### Commander Nago

10 HP, 8 STR, 7 AGL, 15 PRS, lightning trident (d8)
...
8 HP, 10 STR, 12 AGL, 12 PRS, hammer (d6)
...
7 HP, 2 Armor, 14 STR, 4 AGL, 12 PRS, claws and bite (d6+d6)
- Regeneration: Covers itself in molten rock to regain d6 PC.

### Tar Pits

- Moving through the tar pits: Without strict caution or the aid of a guide, those moving through the pits must succeed at a AGL save or step into a seep, one foot caught in sticky black tar.

## Skeleton Cave

### Nereus’s Cave

- Searching Nereus’s bed: Any searching his bed stinks of rotten fish for d4 weeks. While stinking, the Warden might ask for a PRS save to avoid negative reactions in social situations.

### Nereus the Cyclops

16 HP, 2 Armor, 16 STR, 10 AGL, 6 PRS, club (d10+d10) or rock (d8+d8)
- Due to limited depth perception, his attacks are *impaired* against distant or moving targets.

### Traitor’s Arch

- Black Tom: If released, tries to possess one of the PCs: PRS save or be possessed.
...
15 HP, 17 STR, 13 AGL, 14 PRS, claw (d8) or bite (d10), *detachment*
...
14 HP, 2 Armor, 16 STR, 12 AGL, 10 PRS, fist (d6+d6) or eye ray (d6, *blast*), *detachment*
...
- Giant statue’s bolt of energy: Telegraph as written. Find protection (ex: AGL save to take cover) or take d12 STR damage.
...
8 HP, 10 STR, 12 AGL, 2 PRS, fronds (d4, *blast*)
...
12 HP, 3 Armor, 16 STR, 14 AGL, 18 PRS, bite (d12), *detachment*
- Breath of pressurized water: Anyone in a 100ft line must succeed a AGL save or take STR damage equal to Morgawra’s current STR and be shoved backwards 60ft.
...
5 HP, 1 Armor, 10 STR, 12 AGL, 10 PRS, trident (d8)

### Chieftainess Sish

7 HP, 1 Armor, 10 STR, 12 AGL, 14 PRS, trident of fish command (d10, nearby fish obey you)

### Giant Electric Eel

5 HP, 8 STR, 12 AGL, 5 PRS, bite (d6)
- **Critical Damage**: Unleashes an electric shock. The target, as well as any other character within 10ft, takes d8 AGL damage.
...
8 HP, 2 Armor, 17 STR, 12 AGL, 7 PRS, bite (d12), *detachment*
...
14 HP, 13 STR, 15 AGL, 5 PRS, tentacles (d6, *blast*)
...
- Crossing the water-slickened mast: Telegraph as written. AGL save or fall into the pool below (d4 STR damage).
...
12 HP, 1 Armor, 13 STR, 9 AGL, 15 PRS, sword (d10)
...
- Jellyfish swarm sting: Telegraph as written. Those stung take d6 AGL damage, then must succeed a AGL save or be paralyzed for d10 rounds.

### 2.19 Creeping Coral

- Touching the coral: Telegraph that the polyps look inflated, filled with some sort of substance. If touched, AGL save or inhale the cloud. If inhaled, the character can breathe water. Over the course of d4 weeks, scaly patches of coral grow on their skin (+1 armor) until the coral consumes their entire body, killing the host.
...
10 HP, 1 Armor, 13 STR, 10 AGL, 14 PRS, trident (d8, see lightning trident in the appendix)
...
9 HP, 1 Armor, 13 STR, 14 AGL, 11 PRS, bite (d8)
...
17 HP, 18 STR, 10 AGL, 15 PRS, bite (d10) or tentacles (d6, *blast*)
...
9 HP, 13 STR, 16 AGL, 12 PRS, tentacles (d6+d6)
- Displacement: appears 3ft from actual location, attacks against them are *impaired*.
- Resistant to magic: caster must make a PRS save for the intended effect to succeed.

### Thresh

8 HP, 9 STR, 12 AGL, 13 PRS, claw (d4) or wand of lightning bolts (d10, *blast*)

### 3.9 Tower of Secrets

- Obsidian Dagger: d8.
- Reading the symbols: PRS save or be driven mad for d6 turns. Those who succeed increase their PRS score by 1.

### White Ape

7 HP, 15 STR, 13 AGL, 4 PRS, claws (d6+d6) or thrown rock (d6)

### 3.10 Lava Ring

- Falling into lava: Telegraph that the lava rock is only a thin crust above deadly lava. Those walking across must succeed a AGL save to avoid falling. Anyone falling in the lava dies.
...
6 HP, 3 Armor, 15 STR, 12 AGL, 15 PRS, claws (d8+d8) or Rod of Nara-Thul (d12).

### 4.5 Crystal Charger

- Bolts of electricity: Telegraph as written. AGL save or take d8 AGL damage (those wearing metal armor automatically fail.)
...
- Warp beast skin rug: Displacement: wearer appears 3ft from its actual position, attacks against them are *impaired*. Resistant to magic: Enemy caster must make a PRS save for the intended effect to succeed.

### Nara-Thul

Possessing a character: PRS save or be possessed.
...
- Orichalcum Death Mask: A channel of communication is opened to a higher plane of existence, allowing to ask powerful, otherworldly beings for advice and knowledge on any subject. Communion with otherworldly beings of great power can shatter one’s sanity: each use of this power deals d10 PRS damage.

### Brain Squid

14 HP, 15 STR, 13 AGL, 12 PRS, tentacles (d10+d10) or beak (d6)
- Surprise: If a brain squid surprises enemies, its brain lights up in a mesmerizing display. Those observing must succeed at a PRS save or be hypnotized for d4 rounds, unable to move or act.
...
- Touching the boulder: PRS save or fail catatonic for d4 turns.
...
In the center of the platform: d4 AGL damage and a random mutation.
- Mind blast: Forehead veins pulse with light. Focus mental energy into a psychic attack (d10, *blast*). Caster must succeed a PRS save or pass out from the strain.
...
- Removing a crystal: Telegraph that the crystals are crackling with energy and electricity. If removed without protection, be shocked for d8 AGL damage.

### 4.30 Laser Barrier

- The archway can be destroyed with a magical weapon. Damaging the archway causes green sparks to shoot out, dealing d6 AGL damage to the attacker.

### 4.31 Crypt of the Scholars

Console: 
- Electricity zaps out: d4 AGL damage.
- Green light scans: heals everyone in the room for d6 STR and d6 AGL.
- Gravity turns off: when the effect ends, anyone not hanging onto something must succeed at a AGL save or take d6 STR damage as they fall.

### Scholar

14 HP, 8 STR, 14 AGL, 18 PRS, claws (d4+d4)
- Mental defense: immune to mind-affecting magic. All mundane damage they take is *impaired*.
Can cast the following spells at will:
- *Mind blast*: Targets in a 60ft cone (20ft at the end) must succeed at a PRS save or be paralyzed for 1 turn.
- *Flood of Knowledge*: The Scholar forcibly expands the mind of a target within 60ft by flooding it with psychic energy. Targets must succeed at a PRS save or take d12 PRS damage. The first time a character successfully saves against this ability, their max PRS permanently increases by 1.
...
6 HP, 3 Armor, 13 STR, 5 AGL, 10 PRS, blows (d8+d8)
...
6 HP, 13 STR, 10 AGL, 4 PRS, tusk (d8)

### Cassowary

7 HP, 13 STR, 13 AGL, 6 PRS, kicks (d6+d6)
- Cassowaries can jump 7ft into the air.

### Coral Skeleton

5 HP, 1 Armor, 9 STR, 9 AGL, 10 PRS, weapon (d6 or by weapon)

### Crab, Giant

3 HP, 3 Armor, 14 STR, 8 AGL, 4 PRS, pincers (d10+d10)

### Crocodile

6 HP, 13 STR, 13 AGL, 5 PRS, bite (d8)

### Elephant Seal

6 HP, 2 Armor, 14 STR, 8 AGL, 7 PRS, bite (d6)
...
7 HP, 5 STR, 15 AGL, 10 PRS, bite (1 damage)
...
8 HP, 12 STR, 14 AGL, 6 PRS, claws (d4+d4) or bite (d8)

### Killer Vine

6 HP, 10 STR, 12 AGL, 2 PRS, grab (d6)
...
6 HP, 10 STR, 15 AGL, 5 PRS, bite (d6)

### Mantis Shrimp, Giant

10 HP, 2 Armor, 17 STR, 13 AGL, 6 PRS, punches (d10+d10)

### Marine Iguana, Giant

9 HP, 2 Armor, 14 STR, 10 AGL, 5 PRS, claws (d4+d4) or bite (d10)

### Merfolk

3 HP, 10 STR, 12 AGL, 10 PRS, spear (d6) or net

### Merrow

8 HP, 1 Armor, 14 STR, 12 AGL, 10 PRS, spear (d10) or claws and bite (d8+d8)

### Monkey

4 HP, 8 STR, 14 AGL, 9 PRS, sword (d8) or bite (d4) or fling (d6)

### Nephroid

6 HP, 2 Armor, 13 STR, 12 AGL, 10 PRS, claw (d8)

### Pirate

3 HP, 1 Armor, 10 STR, 10 AGL, 10 PRS, sword (d8) or crossbow (d6)

### Pitcher Plant

3 HP, 1 Armor, 8 STR, 10 AGL, 2 PRS, bites (d6+d6)
- Pheromones: Secretes a sweet-smelling fragrance: those within 10ft must succeed at a PRS save or walk into one of the plant’s mouths.
...
3 HP, 5 STR, 12 AGL, 3 PRS, bite (d4)
...
5 HP, 2 Armor, 10 STR, 13 AGL, 8 PRS, bite (d8)
...
3 HP, 7 STR, 10 AGL, 12 PRS, bite (d6)
- Light Sensitivity: When in bright light, the Slageela’s attacks are *impaired* and attacks against them are *enhanced*.

### Spider, Giant Crab

5 HP, 6 STR, 12 AGL, 4 PRS, bite (d8)
- **Critical Damage**: Poison, die in a round.
- Cling: Walks on walls and ceilings. Attacks by dropping on unsuspecting victims from above. 

### Water Termite

7 HP, 9 STR, 14 AGL, 3 PRS, bite (d6)
- Irritant spray: Above water, sprays one target: AGL save or be stunned for 1 turn.
...
12 HP, 3 Armor, 16 STR, 5 AGL, 6 PRS, bite (d12), *detachment*

### Turtle, Snapping

3 HP, 2 Armor, 10 STR, 9 AGL, 4 PRS, bite (d6)

### Wolf Bat

8 HP, 9 STR, 16 AGL, 5 PRS, bite (d6)

### Zombie

2 HP, 12 STR, 6 AGL, 3 PRS, weapon (d8 or by weapon)
