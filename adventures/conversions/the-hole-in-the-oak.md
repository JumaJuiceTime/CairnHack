...
## Spectral Hunter
6 HP, 1 Armor, 12 AGL, 12 PRS, sword (d8), shortbow (d6)
- Abilities as written.
...
## Mutagenic Ogre
6 HP, Armor 1, 15 STR, 8 AGL, 8 PRS, club (d10)
- Abilities as written.
...
## Shadow Gardener
4 HP, 14 PRS, touch (d4, ignores Armor and HP)
...
## Warrior Figment
3 HP, 12 PRS, spear (d8)
- Immune to non-magical attacks.

## Giant Fire Beetles
2 HP, 4 STR, 12 AGL, 6 PRS, bite(d4)
...
6 HP, 14 STR, 12 PRS, bite (d6+d6)
- Abilities as written.

## Adult Heretic Gnomes
4 HP, 8 STR, 12 AGL, 14 PRS, hammer (d6) or crossbow (d8)
- Abilities as written.

## Gnome Leader Grimm
5 HP, 3 Armor, 9 STR, 12 AGL, 14 PRS, hammer (d6) or crossbow (d8)

## Gnome Stump Priestess Gribbl
3 HP, 6 STR, 12 AGL, 15 PRS, knife (d6) or spells
...
## Evil Tree Stump
6 HP, 2 Armor, 14 STR, 6 AGL, roots (d6+d6)
- Once per round the stump gives a simple command to a creature, who must save PRS or obey it. Typically the command is to attack its companions.
